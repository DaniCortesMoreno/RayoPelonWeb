export const OFFICIAL_LIGA_STANDINGS = [
    {
        position: 1,
        teamCode: '13',
 ...
 */
export function parseStandingsFromHtml(html) {
    const teams = [];
...
function generateTeamCode(name, isRayo) {
    if (isRayo)
        return 'RP';
 ...
 */
export function checkScheduleWindow(now = new Date()) {
